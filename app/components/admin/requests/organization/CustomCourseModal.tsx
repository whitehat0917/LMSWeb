...
export default function CustomCourseModal({ selectedRequest, onClose }) {
      ...
      <Grid item xs={12}>
        <Paper style={{ width: '100%' }}>
          <div className={styles.header}>
            <h1 className={styles.headerText}>Custom Course Request</h1>
          ...
          <form>
            <Grid container className={styles.modalContent} spacing={2}>
              ...
              <Grid item xs={12}>
                <label className={styles.lableText}>Course Description</label>
                <p className={styles.textStyle}>
              ...
              <Grid item xs={6}>
                <label className={styles.lableText}>
                  How many learners will take this course
                </label>
                <p className={styles.textStyle}>
                  {selectedRequest.learnerCount} Learners
                </p>
              </Grid>
              <Grid item xs={6}>
                <label className={styles.lableText}>
                ...
                <p className={styles.textStyle}>
                  {selectedRequest?.dateNeeded
                    ? moment(selectedRequest.dateNeeded).format('DD/MM/YYYY')
                    : '-'}
                </p>
              </Grid>
              <Grid item xs={6}>
                <label className={styles.lableText}>What is your budget?</label>
                <p className={styles.textStyle}>
                  {selectedRequest.budgetAmount}
                </p>
              </Grid>
              <Grid item xs={6}>
              ...
              <Grid item xs={6}>
                <label className={styles.lableText}>
                  Do you have any material for us to work with?
                </label>
                <p className={styles.textStyle}>
                  {selectedRequest.hasMaterial === true ? 'Yes' : 'No'}
                </p>
              </Grid>
              <Grid item xs={6}>
