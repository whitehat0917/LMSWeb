...
import BattleboardOrganizationTable from './BattleboardOrganizationTable';

export default function BattleboardOrganization() {
  ...
  return (
    <Grid container>
      ...
      <BattleboardOrganizationTable search={searchValue} />
    </Grid>
  );
}
