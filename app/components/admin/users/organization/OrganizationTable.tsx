        ...
        <TableRow key={`table-row-${index}`} className={classes.tableRow}>
          ...
          <TableCell className={classes.tableData} align="center">
            <Link href={`/admin/settings/${org.id}`} passHref>
              <Button className={classes.tableButton}>Edit Settings</Button>
            </Link>
            <Link href={`/admin/users/organization/${org.id}`} passHref>
              <Button className={classes.tableButton}>View Users</Button>
            </Link>
          </TableCell>
        </TableRow>
      ));
