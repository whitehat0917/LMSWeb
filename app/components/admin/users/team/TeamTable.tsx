import { UserTeamFactory } from '@lms-api/factory';
import {
  Button,
  createStyles,
  makeStyles,
...
const header = ['Team Name', 'Created on', 'Number of Users'];
...
export default function TeamTable({
  ...
  const teamQuery = useQuery(queryKeys.getTeamsByOrgId(organizationId), () =>
    UserTeamFactory.getTeamsByOrgId(organizationId)
  );
  ...
  React.useEffect(() => {
    if (teamData && teamData.length) {
      setTotalPageCount(teamData.length);
    }
  }, [teamData]);
