...
import { CourseFactory } from '@lms-api/factory';
...
export default function Introduction(props) {
  ...
  const coursesQuery = useQuery(queryKeys.getCourseByOrgIdAndId(authnInfo?.userInfo?.organizationId, '69'), () =>
    CourseFactory.get(authnInfo?.userInfo?.organizationId, '69')
  );
      ...
      <>
        ...
        <Box mt={3}>
          <Tabs
            ...
            className="tabs"
          >
            <Tab label="Transcript" {...a11yProps(0)} className="MuiTab_root" />
