...
export default function Qualify(props) {
    ...
    <>
      ...
      <Box display={'flex'} flexWrap={'wrap'}>
        <Grid container spacing={3}>
          {CourseInfo.qualifyContent.map((item, index) => (
            <Grid
              item
              xs={12}
              md={4}
              ...
              onClick={() => downloadDocument(item.src)}
            >
              <Box className={classes.qualifyItem}>
                {item.type === 'pdf' && (
